...
void Memory::removeValue(const string &property, const string &id, const string &value, bool removeAll)
{
  try
  {
    if (removeAll)
    {
      ...
      where[0] = where[1] = where[2] = where[3] = where[4] = where[6] = false;
      where[5] = true;
    ...
    {
      bool *where = new bool[7];
      where[0] = where[1] = where[2] = where[3] = where[4] = false;
      where[5] = where[6] = true;
...
void Memory::setValue(const string &property, const string &id, const string &value)
{
  ...
  {
    bool *get = new bool[7];
    get[0] = get[1] = get[2] = get[3] = get[4] = get[5] = false;
    get[6] = true;
    bool *where = new bool[7];
    where[0] = where[1] = where[2] = where[3] = where[4] = where[6] = false;
    where[5] = true;
...
string Memory::getValue(const string &property, const string &id) { return getValue(property, id, " "); }
...
void Memory::push(const string &name, const string &value, const string &id)
{
  try
  {
    ...
    v1 = v2 = v3 = v4 = v5 = "";
    bool *get = new bool[7];
    get[0] = get[1] = get[2] = get[3] = get[4] = true;
    get[5] = get[6] = false;
    bool *where = new bool[7];
