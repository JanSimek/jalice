...
string TemplateProcessor::getName() const { return "template"; }
string TemplateProcessor::getVersion() const { return "1.0"; }
...
void TemplateProcessor::addProcessor(AimlProcessor *p) { processors[p->getName()] = p; }
